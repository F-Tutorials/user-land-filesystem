...
int ddriver_open(char *path) {
    ...
    sprintf(device_path, "%sbuild/" DEVICE_NAME, "E:/user-land-filesystem/driver/user_ddriver/");//挂载路径
    sprintf(log_path, "%sbuild/" DEVICE_LOG, "E:/user-land-filesystem/driver/user_ddriver/");
